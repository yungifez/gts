...
@section('content')
    ...
    <section class="h-screen text-white bg-black bg-fixed bg-opacity-60 bg-blend-overlay grid place-content-center text-center bg-cover bg-center homepage-image">
