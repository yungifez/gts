@extends('layouts.app')
@section('content')
    <section class="h-screen text-white bg-black bg-opacity-60 bg-blend-overlay grid place-content-center text-center bg-cover" style="background-image: url('{{asset('images/homepage-banner.webp')}}')">
    ...
    <section class="grid place-content-center px-6 py-20 justify-items-center bg-gray-300">
        <h2 class="text-4xl text-center font-bold lg:text-5xl">Welcome to <span class="text-lime-700 block animate-pulse">Gentle Touch Schools</span> </h2>
        <div class="border-4 border-lime-500 w-3/5 lg:w-2/12 my-2"></div>
        <p class="text-gray-600 lg:text-center my-2">Welcome to the official website of Gentle Touch International Schools, the school of wisdom and knowledge. A school created with the sole purpose of training leaders of tomorrow in moral and academic prospects. </p>
    </section>
    <section class="text-pink-700 flex flex-col items-center justify-center p-6 bg:white">
        <h2 data-aos="fade-up" class="text-4xl font-bold lg:text-5xl">What we stand for</h2>
        <div class="flex flex-col lg:flex-row my-10 ">
            <article class="my-4 border-2 border-pink-700 border-solid p-6 lg:m-4" >
            ...
            <article class="my-4 border-2 border-pink-700 border-solid p-6 lg:m-4 aos-init" data-aos="fade-right">
    ...
    <section class="bg-black grid grid-col-1 text-white lg:gap-3 lg:grid-col-4 lg:p-3 ">
        <h2 class="col-span-1 text-center text-4xl font-bold px-3 py-8 lg:col-span-4 ">What we offer</h2>
        <div class="bg-red-600 grid h-96 place-content-center lg:rounded-lg"><p>Creche</p></div>
        <div class="bg-blue-600 grid h-96 place-content-center lg:rounded-lg"><p>Pre school</p></div>
        <div class="bg-yellow-600 grid h-96 place-content-center lg:rounded-lg"><p>Primary</p></div>
        <div class="bg-lime-600 grid h-96 place-content-center lg:rounded-lg"><p>Post primary</p></div>
    </section>
    <section class="grid place-content-center h-96">
        <h2 class="text-4xl text-center text-lime-700 font-bold">We are admitting...</h2>
        <a href="" class="text-center text-pink-700">Follow these steps to apply for admission</a>
    </section>
