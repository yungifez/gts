...
@section('content')
    ...
    <section class=" grid place-content-center px-6 py-20 justify-items-center bg-gray-300 ">
        ...
        <p class="text-gray-600 lg:text-center my-2 animate-on-scroll">Welcome to the official website of Gentle Touch International Schools, the school of wisdom and knowledge. A school created with the sole purpose of training leaders of tomorrow in moral and academic prospects. </p>
    </section>
    ...
    <section class="grid place-content-center h-96">
        ...
        <a href="" class="text-center text-pink-700 g:delay-150 animate-on-scroll">Follow these steps to apply for admission</a>
    </section>
